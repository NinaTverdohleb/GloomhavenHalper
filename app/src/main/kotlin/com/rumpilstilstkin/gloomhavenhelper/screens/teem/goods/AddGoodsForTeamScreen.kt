...
import com.rumpilstilstkin.gloomhavenhelper.testtags.screens.goods.team.AddGoodsForTeamScreenTestTags
...
internal fun AddGoodsForTeamScreen(
    ...
    floatingActionButton = {
        GloomFab(
            modifier = Modifier.testTag(AddGoodsForTeamScreenTestTags.CONFIRM_FAB),
            icon = AppIcon.Check,
            onClick = addGoods,
        )
    },

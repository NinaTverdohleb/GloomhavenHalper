...
enum class GameIcon(val textCode: IconCode, @StringRes val titleRes: Int, val imageRes: Int, val color: Color) {
    ...
    ARIA_0(textCode = IconCode.AREA_0, titleRes = R.string.icon_area, imageRes = R.drawable.ic_aria_0, color = Color.White),
    ARIA_1(textCode = IconCode.AREA_1, titleRes = R.string.icon_area, imageRes = R.drawable.ic_aria_1, color = Color.White),
    ARIA_2(textCode = IconCode.AREA_2, titleRes = R.string.icon_area, imageRes = R.drawable.ic_aria_2, color = Color.White),
    ARIA_3(textCode = IconCode.AREA_3, titleRes = R.string.icon_area, imageRes = R.drawable.ic_aria_3, color = Color.White),
    ARIA_4(textCode = IconCode.AREA_4, titleRes = R.string.icon_area, imageRes = R.drawable.ic_aria_4, color = Color.White),
    ARIA_5(textCode = IconCode.AREA_5, titleRes = R.string.icon_area, imageRes = R.drawable.ic_aria_5, color = Color.White),
    ARIA_6(textCode = IconCode.AREA_6, titleRes = R.string.icon_area, imageRes = R.drawable.ic_aria_6, color = Color.White),
    PLUS_1(textCode = IconCode.PLUS1, titleRes = R.string.icon_plus_1, imageRes = R.drawable.ic_plus_one, color = Color.White),
    PLUS_2(textCode = IconCode.PLUS2, titleRes = R.string.icon_plus_2, imageRes = R.drawable.ic_plus_two, color = Color.White),
    PLUS_3(textCode = IconCode.PLUS3, titleRes = R.string.icon_plus_3, imageRes = R.drawable.ic_plus_three, color = Color.White),
    PLUS_4(textCode = IconCode.PLUS4, titleRes = R.string.icon_plus_4, imageRes = R.drawable.ic_plus_four, color = Color.White),
    PLUS_0(textCode = IconCode.ZERO, titleRes = R.string.icon_plus_0, imageRes = R.drawable.ic_plus_zero, color = Color.White),
    MINUS_1(textCode = IconCode.MINUS1, titleRes = R.string.icon_minus_1, imageRes = R.drawable.ic_minus_one, color = Color.White),
    MINUS_2(textCode = IconCode.MINUS2, titleRes = R.string.icon_minus_2, imageRes = R.drawable.ic_minus_two, color = Color.White),

...
import com.rumpilstilstkin.gloommaster.domain.entity.export.TeamExportDto
import com.rumpilstilstkin.gloommaster.domain.usecase.characters.perks.AddPerksForCharacterUseCase
...
class ImportTeamUseCase @Inject constructor(
    ...
    suspend operator fun invoke(jsonString: String): Result<Unit> =
        runCatching { json.decodeFromString<TeamExportDto>(jsonString) }.map { data ->
            ...
            val teamGoods: Map<Int, List<Int>> =
                data.teamGoods
                    .mapNotNull { number ->
